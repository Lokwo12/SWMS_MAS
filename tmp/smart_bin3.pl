...
bin_fill_every(smart_bin1,3).

bin_fill_every(smart_bin2,4).

bin_fill_every(smart_bin3,5).
...
allow_fill_step:-clause(agent(var_BinID),var__),(clause(fill_tick(var_T),var__)->true;var_T=0),var_T1 is var_T+1,retractall(fill_tick(var__)),assert(fill_tick(var_T1)),(bin_fill_every(var_BinID,var_N)->true;fill_step_every(var_N)),0 is var_T1 mod var_N.
...
trigger_inform_handlers(var_X,var_M,var_Ag):-catch(call(eve(inform_E(var_X,var_Ag))),_519295,true),catch(call(eve(inform_E(var_X,var_M,var_Ag))),_519323,true),catch(call(eve(inform_E(var_X))),_519347,true).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_519059,var_Ontology,_519063),_519053),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_519097)),a(message(var_Ag,propose(var_A,[_519097],var_AgI))),retractall(ext_agent(var_Ag,_519135,var_Ontology,_519139)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_518933,var_Ontology,_518937),_518927),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_519003,var_Ontology,_519007)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_518821,var_Ontology,_518825),_518815),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_518877,var_Ontology,_518881)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_518385),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_518419),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_518201).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_518049),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_517997),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_517873,_517875)),clause(agente(_517895,_517897,_517899,var_S),_517891),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_517667,_517669,_517671,var_S),_517663),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_517767,[]),repeat,read(_517767,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_517767).
